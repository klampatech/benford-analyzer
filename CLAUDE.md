...
**YOU ARE IN: `benford_analyzer/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/benford_analyzer/` (rig root) or other directories
...
**Your mail address:** `benford_analyzer/polecats/chrome`
**Your rig:** benford_analyzer
**Your Witness:** `benford_analyzer/witness`
...
| Ask Witness for help | `gt mail send benford_analyzer/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`benford_analyzer/witness`) when:
...
```bash
gt mail send benford_analyzer/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
